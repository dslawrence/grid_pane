window.grid_panes=[];window.grid_pane_run_needed=0;
(function(g){g.fn.grid_pane=function(p){var c=this;c.meta={};var a=c.meta;c.grid_active=!1;a.gutter_percentage=0.1;a.default_font=12;a.font_factor=28;a.base_width_units=12;a.width_units=a.base_width_units;a.base_height_units=10;a.height_units=a.base_height_units;a.dimension_sets=["m",""];a.dimension_sets_auto=1;a.vertical_center=1;a.show_gutter=1;a.pre_calculations=function(){};a.post_calculations=function(){};a.pre_render=function(){};a.post_render=function(){};a.phone_enabled=!0;a.tablet_enabled=
...
"_off"!=b.vertical_center||"_off"!=b.vertical_center)(d=b.target.html())||(d="9"),e=b.target.height(),b.target.width(),m.html(b.target.clone()),m.find(":first").html('<div class="the_aligner" style="position:relative;">'+d+'<div style="clear:both;"></div></div>'),m.show(),d=g(".the_aligner").height(),m.hide(),d=Math.floor((e-d)/2),0<d&&b.target.css({"padding-top":d,height:e-d});c.meta.post_render(c);a.show_grid_overlay&&c.grid_on()};m.html("");window.grid_panes.push(c);c.run();return c}})(jQuery);
$(function(){setInterval(function(){window.grid_pane_run_needed&&(run_all_grid_panes(),window.grid_pane_run_needed=0)},10);$(window).bind("orientationchange resize",function(){for(var g=0;g<window.grid_panes.length;g++)window.grid_panes[g].hide();window.grid_pane_run_needed=1})});function run_all_grid_panes(){for(var g=0;g<window.grid_panes.length;g++)window.grid_panes[g].show(),window.grid_panes[g].run()};
